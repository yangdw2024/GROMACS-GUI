...
# -*- coding: utf-8 -*-
"""
GROMACS 图形化界面程序 (AVX-512+CUDA+PLUMED完整版)
功能分区 (按分子动力学工作流程排序):
  Part 1: 分子动力学模拟 (完整MD流程)
  Part 2: 结构处理工具 (结构准备、索引生成、编辑结构等)
  Part 3: 高级模拟 (伞形采样、元动力学、ABF等)
  Part 4: 轨迹处理工具 (trjconv/trjcat等)
  Part 5: 结果分析与可视化
  Part 6: 结合自由能计算 (MMPBSA)
  Part 7: 自定义脚本
"""
...
# PyInstaller onefile 模式: 切换工作目录到exe所在目录, 确保版本扫描/配置/资源能正确定位
...
from PyQt5.QtWidgets import (
    ...
    QSpinBox, QDoubleSpinBox, QScrollArea, QFileDialog, QProgressBar,
    QSplitter, QTabWidget, QGridLayout, QMessageBox, QCheckBox,
    QTableWidget, QTableWidgetItem, QHeaderView, QFrame, QSizePolicy,
    QPlainTextEdit, QDialog, QDialogButtonBox, QToolButton, QListWidget,
    QFormLayout
)
from PyQt5.QtCore import Qt, pyqtSignal, QThread, QTimer, QSize, QRect, QPointF
from PyQt5.QtGui import QFont, QIcon, QColor, QTextCharFormat, QTextCursor, QPalette, QPainter, QPen, QBrush
