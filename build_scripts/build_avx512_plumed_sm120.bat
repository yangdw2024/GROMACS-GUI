...
echo ============================================
echo Build GROMACS 2026.3 AVX-512 + CUDA + PLUMED + sm_120
echo ============================================
echo.

set "GMX_SOURCE=D:\YDW\Trae_Gromacs\gromacs\gromacs-2026.3"
set "GMX_BUILD=D:\YDW\Trae_Gromacs\gromacs\build-2026.3-AVX512-CUDA-PLUMED-sm120"
set "GMX_INSTALL=D:\YDW\Trae_Gromacs\gromacs\gromacs-2026.3-AVX512-CUDA-PLUMED-sm120"
