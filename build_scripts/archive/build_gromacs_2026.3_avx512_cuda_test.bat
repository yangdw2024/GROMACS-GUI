...
chcp 65001 >nul
echo ============================================
echo Build GROMACS 2026.3 AVX-512 + CUDA (89;90)
echo ============================================
echo.
...
set "GMX_BUILD=D:\YDW\Trae_Gromacs\gromacs\build-2026.3-AVX512-CUDA-test"
set "GMX_INSTALL=D:\YDW\Trae_Gromacs\gromacs\gromacs-2026.3-AVX512-CUDA-test"
