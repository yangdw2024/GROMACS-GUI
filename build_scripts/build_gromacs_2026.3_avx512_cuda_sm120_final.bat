...
if exist "build-2026.3-AVX512-CUDA-sm120-final" rmdir /s /q "build-2026.3-AVX512-CUDA-sm120-final"
mkdir build-2026.3-AVX512-CUDA-sm120-final
cd build-2026.3-AVX512-CUDA-sm120-final
...
"D:\YDW\Trae_Gromacs\miniconda3\Library\bin\cmake.exe" ^
  ...
  -DGMX_HWLOC=OFF ^
  -DGMX_USE_PLUMED=OFF ^
  -DCMAKE_INSTALL_PREFIX="D:/YDW/Trae_Gromacs/gromacs/gromacs-2026.3-AVX512-CUDA-sm120-final"
...
xcopy /Y "D:\NVIDIA_CUDA_Toolkit\bin\x64\*.dll" "D:\YDW\Trae_Gromacs\gromacs\gromacs-2026.3-AVX512-CUDA-sm120-final\bin\"

echo.
echo Build complete!
"D:\YDW\Trae_Gromacs\gromacs\gromacs-2026.3-AVX512-CUDA-sm120-final\bin\gmx.exe" --version
pause
