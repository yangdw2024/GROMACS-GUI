...
set "GMX_BUILD=D:\YDW\Trae_Gromacs\gromacs\build-2026.3-AVX512-CUDA-sm120-v3"
set "GMX_INSTALL=D:\YDW\Trae_Gromacs\gromacs\gromacs-2026.3-AVX512-CUDA-sm120-v3"
